...
graph TD
    ...
    A --> C[Pay Attention to<br/>Others' Usage]
    A --> D[Natural Acquisition<br/>from Context]
    
    B --> E[Absorb Patterns<br/>Subconsciously]
    C --> F[Notice in Spoken<br/>& Written Language]
    D --> G[Effortless<br/>Usage]
...
```mermaid
graph LR
    A[Simile] --> B[Comparison of<br/>Two Unlike Things]
    A --> C[Uses Markers]
    C --> D["like"]
    C --> E["as"]
    B --> F[Creates Visual<br/>Imagery]
...
```mermaid
graph TB
    A[Metaphor] --> B[Direct Equation]
    A --> C[No Comparison Markers]
    B --> D[Thing A = Thing B]
    C --> E[Implied Comparison]
    
    A --> F[Types]
    F --> G[Simple Metaphor]
    F --> H[Extended Metaphor]
    F --> I[Implied Metaphor]
    ...
    style F fill:#1ABC9C,color:#000
    style G fill:#E67E22,color:#000
    style H fill:#E67E22,color:#000
    style I fill:#E67E22,color:#000
```
...
graph LR
    ...
    S1 -.->|"Softer comparison"| M1
    M1 -.->|"Stronger statement"| S1
    
    style S1 fill:#FFB3BA,color:#000
    style S2 fill:#FFB3BA,color:#000
    style M1 fill:#BAFFC9,color:#000
    style M2 fill:#BAFFC9,color:#000
```
...
```mermaid
graph TB
    A[Personification] --> B[Gives Human<br/>Attributes to]
    B --> C[Objects]
    B --> D[Ideas]
    B --> E[Nature]
    B --> F[Animals]
    ...
    A --> G[Creates]
    G --> H[Poetic Expression]
    G --> I[Deeper Connection]
    G --> J[Emotional Impact]
...
```mermaid
graph TB
    A[Paradox] --> B[Characteristics]
    B --> C[Seems Impossible]
    B --> D[But Contains Truth]
    B --> E[Two Contrasting Ideas]
    
    A --> F[Purpose]
    F --> G[Thought-Provoking]
    F --> H[Adds Depth]
    F --> I[Creates Intellectual Impact]
...
```mermaid
graph LR
    A[Oxymoron] --> B[Two Opposite Words]
    B --> C[Bitter + Sweet]
    B --> D[Awfully + Good]
    B --> E[Sweet + Sorrow]
...
```mermaid
graph TB
    A[Antithesis] --> B[Two Components]
    B --> C[In Opposition]
    B --> D[Parallel Structure]
    
    A --> E[Effects]
    E --> F[Rhythmic Quality]
    E --> G[Memorable Contrast]
    E --> H[Rhetorical Power]
...
graph LR
    ...
    style P1 fill:#FFB3BA,color:#000
    style P2 fill:#FFB3BA,color:#000
    style G1 fill:#BAFFC9,color:#000
    style G2 fill:#BAFFC9,color:#000
```
...
```mermaid
graph TB
    A[Alliteration] --> B[Sound Repetition]
    B --> C[Beginning of Words]
    B --> D[Adjacent Words]
    B --> E[Phrases]
...
```mermaid
graph TB
    A[Types of Alliteration] --> B[Assonance]
    A --> C[Consonance]
    A --> D[Sibilance]
    
    B --> B1[Repetition of<br/>VOWEL sounds]
    B1 --> B2["Too cool for school"]
    
    C --> C1[Repetition of<br/>CONSONANT sounds]
    C1 --> C2["Chips and dips"]
    
    D --> D1[Repetition of<br/>S/SH sounds]
    D1 --> D2["She sells sea shells"]
    ...
    style B2 fill:#FFEAA7,color:#000
    style C1 fill:#FFEAA7,color:#000
    style C2 fill:#FFEAA7,color:#000
...
```mermaid
graph LR
    A[Element 1] --> C[Juxtaposition]
    B[Element 2] --> C
    C --> D[Highlights Differences]
    C --> E[Highlights Similarities]
    C --> F[Creates Meaning]
...
graph TB
    ...
    A --> C[Oxymoron]
    B --> D[Opposing ideas<br/>in parallel structure]
    C --> E[Two opposing words<br/>combined]
...
```mermaid
graph TB
    A[Synecdoche] --> B[Part → Whole]
    A --> C[Whole → Part]
    
    B --> B1["Wheels = Car"]
    B --> B2["Headcount = People"]
    B --> B3["Hands = Workers"]
    
    C --> C1["Police = Some officers"]
    C --> C2["India won = Team won"]
    ...
    style B1 fill:#FFEAA7,color:#000
    style B2 fill:#FFEAA7,color:#000
    style B3 fill:#FFEAA7,color:#000
    style C1 fill:#DDA0DD,color:#000
    style C2 fill:#DDA0DD,color:#000
```
...
```mermaid
graph TB
    A[Anaphora] --> B[Repetition at<br/>Beginning]
    B --> C[Same Word/Phrase]
    B --> D[Successive Clauses]
    B --> E[Successive Sentences]
...
```mermaid
graph TB
    A[Metonymy] --> B[Association-Based<br/>Substitution]
    B --> C[Place → Institution]
    B --> D[Symbol → Entity]
    B --> E[Object → Person]
    
    A --> F[Common Examples]
    F --> G["White House = US President"]
    F --> H["Delhi = Indian Government"]
    F --> I["Kiwis = NZ Cricket Team"]
